...
//        	    System.out.println("value of text variable is "+(i)+text[i]);
      ...
      //  if (failedItems > 20) {
        //	 toEmail = "jaspreet.oberoi@abpdigital.in,rohit.negi@abpdigital.in,shashank.mehta@abpdigital.in,debaditya.bhattacharya@abpdigital.in,abhinav.verma@abpdigital.in,vibhor.maurya@abpdigital.in ";
      //  } else {
        		toEmail = "debaditya.bhattacharya@abpdigital.in,rohit.negi@abpdigital.in,jaspreet.oberoi@abpdigital.in,abhinav.verma@abpdigital.in,ankush.thapa@abpdigital.in";   	
       // 		}
...
*/      
	...
	//	System.out.println(CONFIG.getProperty("testSiteURL"));
       ...
       // EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Total number of articles in ABP are - " + test_sitemap.base.flag +"Total number of articles in Ebela are " + test_sitemap.base.flag +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
	    EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "EBELA HomePage  SectionPage & Tagpage " +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
