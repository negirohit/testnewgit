...
public class abpclass extends ebela_base
{
	public String stringTitleKolkata;
	...
	WebElement polLogin=driver.findElement(By.xpath("//input[@value='Login']"));
		...
		public void openCMKolkata() throws InterruptedException{		
			APP_LOGS.debug("executing open CM Kolkata");
				//goto sub pages
				driver.switchTo().frame(driver.findElement(By.id("work"))).findElement(By.xpath(".//a[contains(text(),'Sub pages')]")).click();
					Thread.sleep(3000);
			//goto à¦•à¦²à¦•à¦¾à¦¤à¦¾ sub pages
				...
				driver.findElement(By.xpath(".//form/div[6]/table/tbody/tr/td/div/div/div/fieldset/div[3]/div/div/div[1]/div[2]/a")).click();
					...
					stringTitleKolkata=driver.findElement(By.xpath("//form/div[6]/table/tbody/tr/td/div/div/div/div[2]/div[1]/fieldset/div/fieldset/div[2]/fieldset/fieldset/span")).getText();	
