...
public class HomeTC_01 extends base
{
	EventFiringWebDriver firingdriver;

	@Test
	@Parameters("browser_name")
	public void homestory_click(String browser_name) throws Exception, Exception
	{
		String testname = "Fortune Home page ATF click";
		...
		Thread.sleep(5000);
		pageclass.homestory_click(firingdriver);
		Thread.sleep(2000);
