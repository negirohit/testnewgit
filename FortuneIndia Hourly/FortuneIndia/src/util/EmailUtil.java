...
public class EmailUtil {
	...
	public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body) throws Exception {
	     try{
	          ...
	          msg.setReplyTo(InternetAddress.parse("debaditya.bhattacharya@abpdigital.com", false));
...
//        	    System.out.println("value of text variable is "+(i)+text[i]);
     ...
     //   if (failedItems > 0) {
       // 	toEmail = "akhil.mudgal@abpdigital.in,jaspreet.oberoi@abpdigital.in,rohit.negi@abpdigital.in,abhinav.verma@abpdigital.in,debaditya.bhattacharya@abpdigital.in";
       // } else {
        		toEmail = "rohit.negi@abpdigital.in,debaditya.bhattacharya@abpdigital.in";   	
        	//	toEmail = "rohit.negi@abpdigital.in,debaditya.bhattacharya@abpdigital.in";
        		//		}
...
*/      
	...
	//	System.out.println(CONFIG.getProperty("testSiteURL"));
       ...
       // EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Total number of articles in ABP are - " + test_sitemap.base.flag +"Total number of articles in Ebela are " + test_sitemap.base.flag +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
	    EmailUtil.sendAttachmentEmail(session, toEmail," Test Report: "+ "FortuneIndia Hourly|Homepage|Sectionpage|Specialpage|Storypage|SearchPage" +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
