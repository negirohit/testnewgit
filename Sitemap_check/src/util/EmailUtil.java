...
public class EmailUtil {
	...
	public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body) throws Exception {
	     try{
	          ...
	          msg.setFrom(new InternetAddress("rohit.negi@abpdigital.in", "NoReply-ABP"));
	          msg.setReplyTo(InternetAddress.parse("1qaz12345", false));
	...
	public static void main(String[] args) throws Exception {
        ...
        final String fromEmail = "rohit.negi@abpdigital.in"; //requires valid email id
        final String password = "1qaz12345"; // correct password for email id
...
//        	    System.out.println("value of text variable is "+(i)+text[i]);
      ...
      //  if (failedItems > 20) {
        	toEmail = "jaspreet.oberoi@abpdigital.in,rohit.negi@abpdigital.in";
      //  } else {
        //		toEmail = "rohit.negi@abpdigital.in";   	
       // 		}
...
*/      
	...
	//	System.out.println(CONFIG.getProperty("testSiteURL"));
       ...
       // EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Total number of articles in ABP are - " + test_sitemap.base.flag +"Total number of articles in Ebela are " + test_sitemap.base.flag +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
	    EmailUtil.sendAttachmentEmail(session, toEmail," Test Report: "+ "ABP and Ebela Sitemap" +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
