...
public class EmailUtil {
	...
	public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body) throws Exception {
	     try{
	          ...
	          //Calling function to attach the HTML report in a Email Body
	           ...
	           body=readFile(System.getProperty("user.dir")+"\\test-output\\Suite 1\\CMS(Telegraph)_Test_Cases.html");
	...
	public static void sendmail() throws Exception {
        ...
        try {
        	...
        	Document doc = docBuilder.parse (new File(System.getProperty("user.dir")+"/test-output/Suite 1/CMS(Telegraph)_Test_Cases.xml"));
      ...
      //  if (failedItems > 20) {
        //	 toEmail = "jaspreet.oberoi@abpdigital.in,rohit.negi@abpdigital.in,debaditya.bhattacharya@abpdigital.in,abhinav.verma@abpdigital.in,vibhor.maurya@abpdigital.in,megha.gupta@abpdigital.in";
      //  } else {
...
*/      
	...
	//	System.out.println(CONFIG.getProperty("testSiteURL"));
       ...
       // EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Total number of articles in ABP are - " + test_sitemap.base.flag +"Total number of articles in Ebela are " + test_sitemap.base.flag +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
	    EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "CMS Daily" +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
