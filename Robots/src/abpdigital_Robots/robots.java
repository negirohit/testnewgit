...
public class robots extends base{
	...
	String m_telegraphindia_Robots="User-agent: *"+'\n'+"Disallow:";
	String imagesEbela_Robots="User-agent: * "+'\n'+"Disallow: /";
	  ...
	  public void startdriver(String browser_name) throws Exception {
		...
		String testname = "Robots Test Cases";
	...
	public void test_Prod_ABP_Robots() throws IOException, InterruptedException
	{
		...
		public void test_imagesABP_Robots(){
			...
			public void test_originABP_Robots(){
				...
				public void test_origin_imagesABP_Robots(){
					...
					@Test(priority=16)
					public void test_m_telegraphindia_Robots()
					{
						driver.navigate().to(CONFIG.getProperty("mtelegraphindia"));
						String robot=driver.findElement(By.cssSelector("html>body>pre")).getText();
						APP_LOGS.debug("URL is.."+CONFIG.getProperty("mtelegraphindia"));
						APP_LOGS.debug("robots text is \n \n"+robot+'\n');
						Assert.assertEquals(robot,m_telegraphindia_Robots);					
	}				
