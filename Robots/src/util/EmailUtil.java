...
public class EmailUtil {
	...
	public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body) throws Exception {
	     try{
	          ...
	          //Calling function to attach the HTML report in a Email Body
	           ...
	           body=readFile(System.getProperty("user.dir")+"\\test-output\\Suite 1\\ABPDigital_robots.html");
	...
	public static void sendmail() throws Exception {
        ...
        final String password = "Menaka*2711"; // correct password for email id
        ...
        try {
        	...
        	Document doc = docBuilder.parse (new File(System.getProperty("user.dir")+"/test-output/Suite 1/ABPDigital_robots.xml"));

        	// normalize text representation
        	doc.getDocumentElement ().normalize ();
        	
        	NodeList results = doc.getElementsByTagName("testsuite");
        	
        	Element firstNameElement = (Element)results.item(0);
        	NamedNodeMap r2 = firstNameElement.getAttributes();
        	
        	System.out.println(r2.getLength()+" "+"Total Length");
        	...
        	Node attr1 = r2.item(4);
        	text[0]=attr1.getNodeName() + " = \"" + attr1.getNodeValue() + "\""; 

        	Node attr2 = r2.item(1);
        	text[1]=attr2.getNodeName() + " = \"" + attr2.getNodeValue() + "\""; 
        ...
        System.out.println("value of passed test cases is..... "+ passedItems);
        final String toEmail;
        
      //  if (failedItems > 20) {
        //	 toEmail = "jaspreet.oberoi@abpdigital.in,rohit.negi@abpdigital.in,debosmita.meshram@abpdigital.in,debaditya.bhattacharya@abpdigital.in,abhinav.verma@abpdigital.in,vibhor.maurya@abpdigital.in ";
      //  } else {
...
*/      
	...
	//	System.out.println(CONFIG.getProperty("testSiteURL"));
       ...
       // EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Total number of articles in ABP are - " + test_sitemap.base.flag +"Total number of articles in Ebela are " + test_sitemap.base.flag +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
	    EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Robots Canonical Check SSL Protocol & Ebela Photo Gallery" +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
