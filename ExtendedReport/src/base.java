...
/*
	...
	*/	
		...
		// Create object of SimpleDateFormat class and decide the format
				 ...
				 File excelFile = new File("D:\\Project\\ExtendedReport\\screenshots\\pingdom_stats.xls");
				   ...
				   */
				   ...
				   //   }
			           ...
			           // row=row+1;
				        ...
				        //Label p = new Label(0,row,date1);
				        Label m = new Label(c,14, pingdom_stat1.get(1).getText());
				//        Label n = new Label(c,11, pingdom_stat1.get(2).getText());
				        Label r1 = new Label(c,15, pingdom_stat1.get(3).getText());
				        Label c1 = new Label(c,16, pingdom_stat1.get(4).getText());
				        //Label s = new Label(4, row, certificates);
				        //sheet.addCell(p);
				        sheet.addCell(m);
				  //      sheet.addCell(n);
