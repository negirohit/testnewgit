...
public static int rows;
	...
	@Test(priority=1)
	public void WebpageTestcall() throws Exception{
		setup();
	...
	@Test(priority=1)
	public void WebpageTestcall2() throws Exception{
		setup();
		driver.navigate().to(CONFIG.getProperty("testSiteURL"));
		//driver.findElement(By.id("url")).sendKeys(CONFIG.getProperty("homePage"));
